...
| Not used in this skill | `followup_task` | No resident agents -- planner and executor are one-shot |
...
- `send_message({ target: "EXEC-001", message: "..." })` -- queue plan solution to running executor
