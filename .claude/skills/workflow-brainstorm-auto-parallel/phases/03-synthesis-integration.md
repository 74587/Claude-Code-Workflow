...
> 来源: `commands/workflow/brainstorm/synthesis.md`
...
### Next Steps
✅ PROCEED: Planning workflow (`workflow-plan/SKILL.md`) --session WFS-{session-id}
```
...
- **Next Action**: Workflow complete, recommend planning workflow (`workflow-plan/SKILL.md`) --session {session_id}
- **TodoWrite**: Collapse Phase 3 sub-tasks to "Phase 3: Synthesis Integration: completed"
